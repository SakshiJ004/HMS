...
//   // ✅ Settings submenu मध्ये Account Settings + Transactions पण add केले
//   useEffect(() => {
//     setOpenSubmenus((prev) => ({
//       ...prev,
//       appointments: isAnyActive([
...
//         all_routes.doctorspasswordsettings,
//         all_routes.doctorsnotificationsettings,
//         all_routes.doctorsaccountsettings,
//         all_routes.doctorstransactions,
//       ]),
//     }));
//     // eslint-disable-next-line
//   }, [location.pathname]);
...
//             </Link>
//           </div>
//           <button className="sidenav-toggle-btn btn border-0 p-0 active" id="toggle_btn" onClick={handleMiniSidebar}>
//             <i className="ti ti-arrow-left" />
//           </button>
//           <button className="sidebar-close" onClick={toggleMobileSidebar}>
//             <i className="ti ti-x align-middle" />
...
//                 <ul>
//                   {/* Dashboard */}
//                   <li className={isActive(all_routes.doctordashboard) ? "active" : ""}>
//                     <Link to={all_routes.doctordashboard}>
//                       <i className="ti ti-layout-dashboard" />
//                       <span>Dashboard</span>
//                     </Link>
...
//                     <Link to="#" onClick={(e) => { e.preventDefault(); handleToggle("appointments"); }}>
//                       <i className="ti ti-calendar-check" />
//                       <span>Appointments</span>
//                       <span className="menu-arrow">
...
//                           className={isActive(all_routes.doctorsappointments) || isActive(all_routes.doctorsappointmentdetails) ? "active" : ""}>
//                           Appointments
//                         </Link>
//                       </li>
//                       <li>
//                         <Link to={all_routes.onlineconsultations}
//                           className={isActive(all_routes.onlineconsultations) ? "active" : ""}>
//                           Online Consultations
//                         </Link>
//                       </li>
//                     </ul>
...
//                   {/* My Schedule */}
//                   <li className={isActive(all_routes.doctorschedule) ? "active" : ""}>
//                     <Link to={all_routes.doctorschedule}>
//                       <i className="ti ti-clock-check" />
//                       <span>My Schedule</span>
//                     </Link>
...
//                   {/* Prescriptions */}
//                   <li className={isActive(all_routes.doctorsprescriptions) || isActive(all_routes.doctorsprescriptiondetails) ? "active" : ""}>
//                     <Link to={all_routes.doctorsprescriptions}>
//                       <i className="ti ti-prescription" />
//                       <span>Prescriptions</span>
//                     </Link>
...
//                   {/* Leave */}
//                   <li className={isActive(all_routes.doctorleaves) ? "active" : ""}>
//                     <Link to={all_routes.doctorleaves}>
//                       <i className="ti ti-calendar-x" />
//                       <span>Leave</span>
//                     </Link>
...
//                   {/* Reviews */}
//                   <li className={isActive(all_routes.doctorreviews) ? "active" : ""}>
//                     <Link to={all_routes.doctorreviews}>
//                       <i className="ti ti-star" />
//                       <span>Reviews</span>
//                     </Link>
...
//                   {/* ✅ Settings Submenu - Account Settings + Transactions ADD केले */}
//                   <li className={`submenu${openSubmenus.settings ? " active" : ""}`}>
//                     <Link to="#" onClick={(e) => { e.preventDefault(); handleToggle("settings"); }}>
//                       <i className="ti ti-settings" />
//                       <span>Settings</span>
//                       <span className="menu-arrow">
//                         <i className={openSubmenus.settings ? "ti ti-chevron-down" : "ti ti-chevron-right"} />
//                       </span>
//                     </Link>
//                     <ul style={{ display: openSubmenus.settings ? "block" : "none" }}>
//                       <li>
//                         <Link to={all_routes.doctorsprofilesettings}
//                           className={isActive(all_routes.doctorsprofilesettings) ? "active" : ""}>
//                           Profile Settings
//                         </Link>
//                       </li>
//                       <li>
//                         <Link to={all_routes.doctorspasswordsettings}
//                           className={isActive(all_routes.doctorspasswordsettings) ? "active" : ""}>
//                           Change Password
//                         </Link>
//                       </li>
//                       <li>
//                         <Link to={all_routes.doctorsnotificationsettings}
//                           className={isActive(all_routes.doctorsnotificationsettings) ? "active" : ""}>
//                           Notifications
//                         </Link>
//                       </li>
//                       {/* ✅ नवीन ADD */}
...
//                           className={isActive(all_routes.doctorsaccountsettings) ? "active" : ""}>
//                           Account Settings
//                         </Link>
//                       </li>
//                       <li>
//                         <Link to={all_routes.doctorstransactions}
//                           className={isActive(all_routes.doctorstransactions) ? "active" : ""}>
//                           Transactions
//                         </Link>
//                       </li>
//                     </ul>
...
//             <div className="trial-item mt-0 p-3 text-center">
//               <div className="trial-item-icon rounded-4 mb-3 p-2 text-center shadow-sm d-inline-flex">
//                 <ImageWithBasePath src="./assets/img/icons/sidebar-icon.svg" alt="img" />
//               </div>
//               <div>
//                 <h6 className="fs-14 fw-semibold mb-1">Upgrade To Pro</h6>
//                 <p className="fs-13 mb-0">Check 1 min video and begin use Preclinic like a pro</p>
//               </div>
//               <Link to="#" className="close-icon shadow-sm">
//                 <i className="ti ti-x" />
//               </Link>
