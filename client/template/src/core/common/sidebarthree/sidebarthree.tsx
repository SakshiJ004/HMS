          ...
          <div id="sidebar-menu" className="sidebar-menu">
            <ul>
              ...
              <li>
                <ul>
                  {/* Dashboard */}
                  <li className={isActive(routes.patientdashboard) ? "active" : ""}>
                    <Link to={routes.patientdashboard}>
                      <i className="ti ti-layout-dashboard" />
                      <span>Dashboard</span>
                    </Link>
                  ...
                  {/* Appointments */}
                  <li className={isActive(routes.patientappointments) || isActive(routes.patientappointmentdetails) ? "active" : ""}>
                    <Link to={routes.patientappointments}>
                      <i className="ti ti-calendar-check" />
                      <span>Appointments</span>
                    </Link>
                  ...
                  {/* Doctors */}
                  <li className={isActive(routes.patientdoctors) ? "active" : ""}>
                    <Link to={routes.patientdoctors}>
                      <i className="ti ti-stethoscope" />
                      <span>Doctors</span>
                    </Link>
                  ...
                  {/* Prescriptions */}
                  <li className={isActive(routes.patientPrescriptions) || isActive(routes.patientprescriptiondetails) ? "active" : ""}>
                    <Link to={routes.patientPrescriptions}>
                      <i className="ti ti-prescription" />
                      <span>Prescriptions</span>
                    </Link>
                  ...
                  {/* Invoice */}
                  <li className={isActive(routes.patientinvoices) || isActive(routes.patientinvoicedetails) ? "active" : ""}>
                    <Link to={routes.patientinvoices}>
                      <i className="ti ti-star" />
                      <span>Invoice</span>
                    </Link>
                  ...
                  <li className={`submenu${openSubmenus.settings ? " active" : ""}`}>
                    ...
                    <ul style={{ display: openSubmenus.settings ? "block" : "none" }}>
                      <li>
                        <Link to={routes.patientprofilesettings}
                          className={isActive(routes.patientprofilesettings) ? "active" : ""}>
                          Profile Settings
                        </Link>
                      </li>
                      <li>
                        <Link to={routes.patientpasswordsettings}
                          className={isActive(routes.patientpasswordsettings) ? "active" : ""}>
                          Change Password
                        </Link>
                      </li>
                      <li>
                        <Link to={routes.patientnotificationssettings}
                          className={isActive(routes.patientnotificationssettings) ? "active" : ""}>
                          Notifications
                        </Link>
                      </li>
                    </ul>
