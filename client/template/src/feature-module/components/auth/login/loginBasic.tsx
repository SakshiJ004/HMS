...
const LoginBasic = () => {
  ...
  // Check if user has Remember Me enabled on component mount
  useEffect(() => {
    ...
    // Check for error from social login
    const error = searchParams.get("error");
    if (error === "authentication_failed") {
      setErrorMessage("Social authentication failed. Please try again.");
    }
  }, [searchParams]);
