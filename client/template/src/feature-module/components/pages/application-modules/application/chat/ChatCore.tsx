    ...
    <div style={{ position: "relative", width: size, height: size, flexShrink: 0 }}>
        {image ? (
            ...
            <div style={{
                ...
                color: "white", fontWeight: "bold", fontSize: size * 0.38, flexShrink: 0
            }}>
...
const ChatCore = ({ wrapperStyle }: ChatCoreProps) => {
                    ...
                    <div style={{ padding: "16px 16px 12px", borderBottom: "1px solid #f0f0f0" }}>
                        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 12 }}>
                            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                                <Avatar name={MY_NAME} image={MY_IMAGE} size={38} showOnline />
                                <div>
                                    <p style={{ margin: 0, fontWeight: 600, fontSize: 14 }}>{MY_NAME}</p>
                        ...
                        <div style={{ position: "relative" }}>
                            ...
                            <input
                                ...
                                style={{
                                    width: "100%", padding: "8px 8px 8px 32px", border: "1px solid #e9ecef",
                        ...
                        {filtered.length === 0 ? (
                            <div style={{ textAlign: "center", padding: "40px 20px", color: "#aaa" }}>
                                ...
                                <button onClick={() => setShowNewChat(true)} style={{
                                    marginTop: 12, background: "#4f46e5", color: "white", border: "none",
                            ...
                            return (
                                <div key={conv._id} onClick={() => openConversation(conv)} style={{
                                    ...
                                    cursor: "pointer", background: isActive ? "#f0f0ff" : "transparent",
                                    borderLeft: isActive ? "3px solid #4f46e5" : "3px solid transparent",
                                    borderBottom: "1px solid #f8f8f8", transition: "background 0.1s",
                                    position: "relative"
                                }}>
                                    <Avatar name={other.name} image={other.image} size={42} showOnline />
                                    <div style={{ flex: 1, overflow: "hidden", marginLeft: 12 }}>
                                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                                            <span style={{ fontWeight: 600, fontSize: 14, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", maxWidth: 120 }}>
                                                {other.name}
                                            </span>
                                        ...
                                        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 2 }}>
                                            <p style={{ margin: 0, fontSize: 12, color: "#888", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", maxWidth: 150 }}>
                                    ...
                                    <div style={{ position: "absolute", right: 8, top: 8 }}>
                                        <div className="dropdown">
                                            <button
                                                ...
                                                <i className="ti ti-dots-vertical" style={{ fontSize: 12 }} />
                                            </button>
                ...
                {activeConv ? (
                    <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden", background: "#f8f9fa" }}>
                        ...
                        <div style={{
                            ...
                            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                                <Avatar name={getOther(activeConv).name} image={getOther(activeConv).image} size={42} showOnline />
                                <div>
                        ...
                        <div style={{ flex: 1, overflowY: "auto", padding: "20px 16px" }}>
                            {loadingMsgs ? (
                                ...
                                <div style={{ textAlign: "center", paddingTop: 60, color: "#aaa" }}>
                                    <i className="ti ti-message" style={{ fontSize: "3rem", display: "block", marginBottom: 8 }} />
                                ...
                                messages.map(msg => {
                                    ...
                                    return (
                                        <div key={msg._id} style={{
                                            ...
                                            <Avatar name={isMe ? MY_NAME : msg.sender} image={isMe ? MY_IMAGE : msg.senderImage} size={32} />
                                            <div style={{ maxWidth: "65%" }}>
                                                ...
                                                <div style={{ display: "flex", alignItems: "center", gap: 6, flexDirection: isMe ? "row-reverse" : "row" }}>
                                                    ...
                                                    <div className="dropdown">
                                                        <button data-bs-toggle="dropdown" style={{
                                                            ...
                                                            color: "#ccc", padding: 2, opacity: 0.6
                                                        }}>
                                                ...
                                                {isMe && (
                                                    <div style={{ textAlign: "right", marginTop: 2 }}>
                                                        <i className="ti ti-checks" style={{ fontSize: 11, color: "#22c55e" }} />
                                                    </div>
                                                )}
                                            </div>
                                        </div>
                    ...
                    <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center" }}>
                        <div style={{ textAlign: "center", color: "#aaa" }}>
                            ...
                            <h5 style={{ fontWeight: 600, marginBottom: 8 }}>Your Messages</h5>
                            <p style={{ fontSize: 14, marginBottom: 20 }}>Select a chat or start a new conversation</p>
                            <button onClick={() => setShowNewChat(true)} style={{
                                background: "#4f46e5", color: "white", border: "none", borderRadius: 8,
                                padding: "10px 24px", cursor: "pointer", fontSize: 14, fontWeight: 500
                            }}>
                                <i className="ti ti-plus" style={{ marginRight: 8 }} />New Chat
                            </button>
                        </div>
                    </div>
                )}
                    ...
                    <div style={{
                        ...
                        <div style={{ padding: "16px 24px" }}>
                            <div style={{ position: "relative", marginBottom: 12 }}>
                                <i className="ti ti-search" style={{ position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)", color: "#aaa" }} />
                                <input
                                    type="text" autoFocus
                                    placeholder="Search by name or role..."
                                    value={userSearch} onChange={e => setUserSearch(e.target.value)}
                                    style={{
                                        width: "100%", padding: "10px 10px 10px 36px", border: "1px solid #e9ecef",
                                        borderRadius: 8, fontSize: 14, outline: "none", background: "#f8f9fa",
                                ...
                                {filteredUsers.length === 0 ? (
                                    ...
                                    <div key={user._id} onClick={() => setSelectedUser(user)} style={{
                                        ...
                                        <span style={{
                                            ...
                                            background: user.type === "doctor" ? "#ede9fe" : "#dcfce7",
                                            color: user.type === "doctor" ? "#7c3aed" : "#16a34a"
                                        }}>
                        ...
                        <div style={{ padding: "12px 24px 20px", display: "flex", justifyContent: "flex-end", gap: 8 }}>
                            ...
                            <button onClick={handleStartChat} disabled={!selectedUser} style={{
                                padding: "8px 24px", border: "none", borderRadius: 8, cursor: selectedUser ? "pointer" : "not-allowed",
