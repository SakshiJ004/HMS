...
//   // Form state - ✅ Changed default status to "Scheduled"
//   const [formData, setFormData] = useState({
//     patient: "",
//     doctor: "",
//     department: "",
...
//     reason: "",
//     status: "Scheduled", // ✅ FIXED: Changed from "Schedule" to "Scheduled"
//   });
...
//     { value: "Scheduled", label: "Scheduled" }, // ✅ FIXED: Changed from "Schedule"
//     { value: "Confirmed", label: "Confirmed" },
//     { value: "Checked In", label: "Checked In" },
//     { value: "Checked Out", label: "Checked Out" },
//     { value: "Cancelled", label: "Cancelled" },
...
//                             })}
//                             onChange={(option: any) => setFormData(prev => ({ ...prev, patient: option?.value || "" }))}
//                           />
//                         </div>
//                       </div>
...
//                             className="select"
//                             placeholder="Select Department"
//                             onChange={(option: any) => setFormData(prev => ({ ...prev, department: option?.value || "" }))}
//                           />
//                         </div>
//                       </div>
//                     </div>
...
//                             className="select"
//                             placeholder="Select Doctor"
//                             onChange={(option: any) => setFormData(prev => ({ ...prev, doctor: option?.value || "" }))}
//                           />
//                         </div>
//                       </div>
...
//                             className="select"
//                             placeholder="Select Type"
//                             onChange={(option: any) => setFormData(prev => ({ ...prev, appointmentType: option?.value || "" }))}
//                           />
//                         </div>
//                       </div>
//                     </div>
