...
const NewAppointment = () => {
  ...
  const handlePatientAdded = () => {
    fetchDoctorsAndPatients();
    message.success("Patient added successfully! You can now select them.");
  };
  ...
  // ✅ SMART CANCEL BUTTON LOGIC - Handles all 3 scenarios
  const handleCancel = () => {
    // Scenario 1: Form is empty - Navigate directly to appointments list
    if (isFormEmpty()) {
      navigate(all_routes.appointments);
      return;
    }

    // Scenario 2: Form has data - Show confirmation before discarding
    ...
    // If not confirmed, stay on page with data intact
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Scenario 3: After successful creation - Navigate to appointments list
      setTimeout(() => {
        navigate(all_routes.appointments);
      }, 1000);
    } catch (error: any) {
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="mb-3">
                      ...
                      <small className="text-muted">
                        Appointment ID will be generated automatically (e.g., AP0001)
                      </small>
                    </div>
                    ...
                    {/* Submit Buttons with Smart Cancel Logic */}
                    <div className="d-flex align-items-center justify-content-end mt-4">
                      <button
                        type="button"
