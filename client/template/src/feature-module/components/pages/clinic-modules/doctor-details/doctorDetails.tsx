      ...
      <div className="page-wrapper">
        <div className="content pb-0">
          ...
          <div className="card">
            <div className="card-body d-flex align-items-center justify-content-between flex-wrap row-gap-3">
              <div className="d-flex align-items-center flex-sm-nowrap flex-wrap row-gap-3">
                <div className="me-3 doctor-profile-img" style={{ width: '100px', height: '100px', flexShrink: 0 }}>
                  {getProfileImage() ? (
                    <img
                      src={getProfileImage()!}
                      className="rounded"
                ...
                <div className="flex-fill">
                  <div className="d-flex align-items-center mb-1">
                    <h6 className="mb-0 fw-semibold">Dr. {doctor.fullName}</h6>
                    <span className="badge border bg-white text-dark fw-medium ms-2">
                      <i className="ti ti-point-filled me-1 text-info" />
                      {doctor.department}
                    </span>
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <span className={`badge ${doctor.displayOnBookingPage ? 'badge-soft-success' : 'badge-soft-secondary'} fw-medium ms-2`}>
                      <i className={`ti ti-point-filled me-1 ${doctor.displayOnBookingPage ? 'text-success' : 'text-secondary'}`} />
                      {doctor.displayOnBookingPage ? 'Available' : 'Unavailable'}
                    </span>
                  </div>
                </div>
              </div>
              <div>
                ...
                <Link
                  to={`${all_routes.newAppointment}?doctorId=${doctorId}&doctorName=${doctor?.fullName}&department=${doctor?.department}`}
                  className="btn btn-primary"
                >
                  ...
                  <div className="card-body">
                    ...
                    <ul className="nav nav-tabs nav-bordered nav-border-bottom mb-3">
                      {doctor.schedules.map((schedule, index) => (
                        <li className="nav-item flex-fill" key={schedule.day}>
                          <Link
                            className={`nav-link text-center fw-semibold ${index === 0 ? 'active' : ''}`}
                            to="#"
                            data-bs-toggle="tab"
                            data-bs-target={`#schedule-${index}`}
                          >
                            {schedule.day}
                          </Link>
                        </li>
                  ...
                  <div className="card-body">
                    ...
                    <ul className="activity-feed rounded">
                      {doctor.education.map((edu, index) => (
                        <li className="feed-item timeline-item" key={index}>
                          <h6 className="fw-bold mb-2">
                  ...
                  <div>
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <div>
                        ...
                        <p className="mb-0">{doctor.medicalLicenseNumber}</p>
                      </div>
                    </div>
                    <div className="d-flex align-items-center mb-3">
                      <span className="avatar rounded-circle bg-light text-dark fs-16 flex-shrink-0 me-2">
                    ...
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <div>
                        ...
                        <p className="mb-0">
                          ...
                          {doctor.address.address2 && `, ${doctor.address.address2}`}
                          <br />
                    ...
                    <div className="d-flex align-items-center mb-3">
                      ...
                      <div>
                        <h6 className="fw-semibold fs-13 mb-1">DOB</h6>
                        <p className="mb-0">{formatDate(doctor.dob)}</p>
                      </div>
                    </div>
                    <div className="d-flex align-items-center mb-3">
                      <span className="avatar rounded-circle bg-light text-dark fs-16 flex-shrink-0 me-2">
                      ...
                      <div>
                        <h6 className="fw-semibold fs-13 mb-1">Blood Group</h6>
                        <p className="mb-0">{doctor.bloodGroup}</p>
                      </div>
                    </div>
                    <div className="d-flex align-items-center mb-3">
                      <span className="avatar rounded-circle bg-light text-dark fs-16 flex-shrink-0 me-2">
                      ...
                      <div>
                        ...
                        <p className="mb-0">{doctor.yearOfExperience}+ Years</p>
                      </div>
                    </div>
                    <div className="d-flex align-items-center mb-3">
                      <span className="avatar rounded-circle bg-light text-dark fs-16 flex-shrink-0 me-2">
                      ...
                      <div>
                        <h6 className="fw-semibold fs-13 mb-1">Gender</h6>
                        <p className="mb-0">{doctor.gender}</p>
                      </div>
                    </div>
                    {doctor.languageSpoken && doctor.languageSpoken.length > 0 && (
                      <div className="d-flex align-items-center">
                        ...
                        <div>
                          <h6 className="fw-semibold fs-13 mb-1">Languages</h6>
                          <p className="mb-0">{doctor.languageSpoken.join(', ')}</p>
                        </div>
                      </div>
                    )}
                  </div>
...
export default DoctorDetailsReal;