...
// ✅ Dynamic department option type
...
const EditDoctor = () => {
    ...
    const fetchSpecializations = async () => {
      try {
        ...
        if (res.data.success && res.data.data.length > 0) {
          const options = res.data.data.map((spec: { name: string }) => ({
            value: spec.name,
            label: spec.name,
          }));
  ...
  const [formData, setFormData] = useState<DoctorFormData>({
    ...
    dob: "", yearOfExperience: "", department: "", designation: "",
    medicalLicenseNumber: "", languageSpoken: [], bloodGroup: "", gender: "",
    bio: "", featureOnWebsite: false,
    address: { address1: "", address2: "", city: "", state: "", country: "", pincode: "" },
    appointmentType: "", acceptBookingsDays: 0, appointmentDuration: 30,
    consultationCharge: 0, maxBookingsPerSlot: 1, displayOnBookingPage: false,
    education: [], awards: [], certifications: [], schedules: [], profileImage: "",
  });
  ...
  const handleScheduleChange = (day: string, schedules: Array<{ startTime: string; endTime: string }>) => {
    setFormData((prev) => {
      ...
      const filteredSchedules = existingSchedules.filter((s) => s.day !== day);
      const existingDaySchedule = existingSchedules.find((s) => s.day === day);
      if (existingDaySchedule && JSON.stringify(existingDaySchedule.timeSlots) === JSON.stringify(schedules)) return prev;
      return { ...prev, schedules: [...filteredSchedules, { day, timeSlots: schedules }] };
    });
  };
  ...
  const handleAwardsChange = (awards: Array<{ title: string; year: string }>) => {
    setFormData((prev) => {
      if (JSON.stringify(prev.awards) === JSON.stringify(awards)) return prev;
      return { ...prev, awards };
    });
  };
  ...
  const handleCertificationsChange = (certifications: Array<{ title: string; year: string }>) => {
    setFormData((prev) => {
      if (JSON.stringify(prev.certifications) === JSON.stringify(certifications)) return prev;
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!doctorId) { setError("Doctor ID is missing"); return; }
    try {
      setLoading(true);
      setError("");
      setSuccess("");
                ...
                <div className="card-body">
                  ...
                  <form onSubmit={handleSubmit}>
                      ...
                      <div className="row">
                        <div className="col-lg-12">
                          <div className="mb-3 d-flex align-items-center">
                            ...
                            <div className="drag-upload-btn avatar avatar-xxl rounded-circle bg-light text-muted position-relative overflow-hidden z-1 mb-2 ms-4 p-0">
                              {profilePreview ? (
                                <img src={profilePreview} className="position-relative z-n1 w-100 h-100" style={{ objectFit: "cover" }} alt="Profile" />
                              ) : (
                                <div className="w-100 h-100 d-flex align-items-center justify-content-center bg-primary text-white fs-24 fw-bold">
                                  {getInitials(formData.firstName, formData.lastName)}
                                </div>
                              )}
                              <input type="file" className="form-control image-sign" accept="image/*" onChange={handleProfileImageChange} />
                              <div className="position-absolute bottom-0 end-0 star-0 w-100 h-25 bg-dark d-flex align-items-center justify-content-center z-n1">
                          ...
                          <div className="row">
                            <div className="col-lg-6">
                              <div className="mb-3">
                                ...
                                <input type="text" className="form-control" value={formData.firstName} onChange={(e) => handleInputChange("firstName", e.target.value)} required />
                              </div>
                            </div>
                            <div className="col-lg-6">
                              <div className="mb-3">
                                <label className="form-label">Last Name <span className="text-danger">*</span></label>
                                <input type="text" className="form-control" value={formData.lastName} onChange={(e) => handleInputChange("lastName", e.target.value)} required />
                              </div>
                            </div>
                            <div className="col-lg-6">
                              <div className="mb-3">
                                <label className="form-label">Username <span className="text-danger">*</span></label>
                                <input type="text" className="form-control" value={formData.username} onChange={(e) => handleInputChange("username", e.target.value)} required />
                              </div>
                            </div>
                            <div className="col-lg-6">
                              <div className="mb-3">
                                <label className="form-label">Email Address <span className="text-danger">*</span></label>
                                <input type="email" className="form-control" value={formData.email} onChange={(e) => handleInputChange("email", e.target.value)} required />
                              </div>
                            </div>
                            <div className="col-lg-6">
                              <div className="mb-3">
                                <label className="form-label">Phone Number <span className="text-danger">*</span></label>
                                <PhoneInput defaultCountry="US" value={formData.phone} onChange={(value) => handleInputChange("phone", value || "")} />
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="row">
                            ...
                            <div className="col-lg-6">
                              <div className="mb-3">
                                ...
                                <input type="text" className="form-control" value={formData.yearOfExperience} onChange={(e) => handleInputChange("yearOfExperience", e.target.value)} required />
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="row">
                            <div className="col-lg-6">
                              <div className="mb-3">
                                ...
                                {/* ✅ Dynamic dropdown - pre-selects existing doctor's department */}
                                {departmentsLoading ? (
                          ...
                          <div className="row">
                            <div className="col-lg-6">
                              <div className="mb-3">
                                ...
                                <input type="text" className="form-control" value={formData.medicalLicenseNumber} onChange={(e) => handleInputChange("medicalLicenseNumber", e.target.value)} required />
                              </div>
                            </div>
                            <div className="col-lg-6">
                              <div className="mb-3">
                        ...
                        <div className="col-lg-12">
                          <div className="mb-3">
                            <label className="form-label">Bio</label>
                            <textarea className="form-control" rows={3} value={formData.bio} onChange={(e) => handleInputChange("bio", e.target.value)} />
                          </div>
                          <div className="form-check form-switch mb-3">
                            <label className="form-check-label" htmlFor="featureWebsite">Feature On Website</label>
                            <input className="form-check-input" type="checkbox" role="switch" id="featureWebsite" checked={formData.featureOnWebsite} onChange={(e) => handleInputChange("featureOnWebsite", e.target.checked)} />
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="pb-0">
                      <div className="row">
                        <div className="col-lg-6">
                          <div className="mb-3">
                            <label className="form-label">Address 1</label>
                            <input type="text" className="form-control" value={formData.address.address1} onChange={(e) => handleAddressChange("address1", e.target.value)} />
                          </div>
                        </div>
                        <div className="col-lg-6">
                          <div className="mb-3">
                            <label className="form-label">Address 2</label>
                            <input type="text" className="form-control" value={formData.address.address2} onChange={(e) => handleAddressChange("address2", e.target.value)} />
                          </div>
                        </div>
                      </div>
                      <div className="row">
                        <div className="col-lg-6">
                          <div className="mb-3">
                            <label className="form-label">Country</label>
                            <CommonSelect options={Country} className="select" value={Country.find((c) => c.value === formData.address.country)} onChange={(option: any) => handleAddressChange("country", option.value)} />
                          </div>
                        </div>
                        <div className="col-lg-6">
                          <div className="mb-3">
                            <label className="form-label">City</label>
                            <CommonSelect options={City} className="select" value={City.find((c) => c.value === formData.address.city)} onChange={(option: any) => handleAddressChange("city", option.value)} />
                          </div>
                        </div>
                      </div>
                      <div className="row">
                        <div className="col-lg-6">
                          <div className="mb-3">
                            <label className="form-label">State</label>
                            <CommonSelect options={State} className="select" value={State.find((s) => s.value === formData.address.state)} onChange={(option: any) => handleAddressChange("state", option.value)} />
                          </div>
                        </div>
                        <div className="col-lg-6">
                          <div className="mb-3">
                            <label className="form-label">Pincode</label>
                            <input type="text" className="form-control" value={formData.address.pincode} onChange={(e) => handleAddressChange("pincode", e.target.value)} />
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="tab-content">
                        {["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"].map((day) => (
                          <div key={day} className={`tab-pane fade ${activeDay === day ? "active show" : ""}`}>
                            <div className="add-schedule-list">
                              <DuplicateForms
                                onScheduleChange={(schedules) => handleScheduleChange(day, schedules)}
                                scheduleData={formData.schedules?.find((s) => s.day === day)?.timeSlots || []}
                              />
                            </div>
                          </div>
                        ))}
                      ...
                      <div className="mb-3">
                        <button
                          ...
                          className="btn btn-dark"
                          onClick={() => {
                            const currentSchedule = formData.schedules?.find((s) => s.day === activeDay)?.timeSlots || [];
                    ...
                    <div className="pb-0">
                      <div className="row">
                        <div className="col-lg-6">
                          <div className="mb-3">
                            <label className="form-label">Appointment Type</label>
                            <CommonSelect options={Appointment_Type} className="select" value={Appointment_Type.find((a) => a.value === formData.appointmentType)} onChange={(option: any) => handleInputChange("appointmentType", option.value)} />
                          </div>
                        </div>
                        <div className="col-lg-6" />
                        <div className="col-lg-6">
                          <div className="mb-3">
                            <label className="form-label">Accept bookings (in Advance)</label>
                            <div className="input-group">
                              <input type="number" className="form-control" value={formData.acceptBookingsDays} onChange={(e) => handleInputChange("acceptBookingsDays", parseInt(e.target.value) || 0)} />
                              <span className="input-group-text bg-transparent text-dark fs-14">Days</span>
                            </div>
                          </div>
                        </div>
                        <div className="col-lg-6">
                          <div className="mb-3">
                            <label className="form-label">Appointment Duration</label>
                            <div className="input-group">
                              <input type="number" className="form-control" value={formData.appointmentDuration} onChange={(e) => handleInputChange("appointmentDuration", parseInt(e.target.value) || 30)} />
                              <span className="input-group-text bg-transparent text-dark fs-14">Mins</span>
                            </div>
                          </div>
                        </div>
                        <div className="col-lg-6">
                          <div className="mb-3">
                            <label className="form-label">Consultation Charge</label>
                            <div className="input-group">
                              <input type="number" className="form-control" value={formData.consultationCharge} onChange={(e) => handleInputChange("consultationCharge", parseInt(e.target.value) || 0)} />
                              <span className="input-group-text bg-transparent text-dark fs-14">$</span>
                            </div>
                          </div>
                        </div>
                        <div className="col-lg-6">
                          <div className="mb-3">
                            <label className="form-label">Max Bookings Per Slot</label>
                            <input type="number" className="form-control" value={formData.maxBookingsPerSlot} onChange={(e) => handleInputChange("maxBookingsPerSlot", parseInt(e.target.value) || 1)} />
                          </div>
                        </div>
                        <div className="col-md-6">
                          <div className="form-check form-switch mb-3">
                            <label className="form-check-label" htmlFor="displayBooking">Display on Booking Page</label>
                            <input className="form-check-input" type="checkbox" role="switch" id="displayBooking" checked={formData.displayOnBookingPage} onChange={(e) => handleInputChange("displayOnBookingPage", e.target.checked)} />
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="pb-0">
                      <div className="add-education-list">
                        <EducationForms onEducationChange={handleEducationChange} educationData={formData.education} />
                      </div>
                    </div>
                    ...
                    <div className="pb-0">
                      <div className="add-award-list">
                        <RewardsForms onRewardsChange={handleAwardsChange} rewardsData={formData.awards} />
                      </div>
                    </div>
                    ...
                    <div className="pb-3 mb-3 border-bottom">
                      <div className="add-certification-list">
                        <RewardsForms onRewardsChange={handleCertificationsChange} rewardsData={formData.certifications} />
                      </div>
                    </div>

                    <div className="d-flex justify-content-end gap-2">
                      <Link to={all_routes.doctors} className="btn btn-light btm-md">Cancel</Link>
                      <button type="submit" className="btn btn-primary btm-md" disabled={loading}>
                        {loading ? "Saving..." : "Save Changes"}
                      </button>
                    </div>
