...
const Modals = ({
  ...
  // ✅ Authorization header काढला — इतर modules सारखं open API
        ...
        <div className="modal fade show d-block" style={{ backgroundColor: "rgba(0,0,0,0.5)" }}>
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-header">
                <h4 className="text-dark modal-title fw-bold">Add New Specialization</h4>
                <button type="button" className="btn-close btn-close-modal custom-btn-close" onClick={onAddClose}>
                  <i className="ti ti-x" />
                </button>
              </div>
              <form onSubmit={handleAdd}>
        ...
        <div className="modal fade show d-block" style={{ backgroundColor: "rgba(0,0,0,0.5)" }}>
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-header">
                <h4 className="text-dark modal-title fw-bold">Edit Specialization</h4>
                <button type="button" className="btn-close btn-close-modal custom-btn-close" onClick={onEditClose}>
                  <i className="ti ti-x" />
                </button>
              </div>
              <form onSubmit={handleEditSave}>
