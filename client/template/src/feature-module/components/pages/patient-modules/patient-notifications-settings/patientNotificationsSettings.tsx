...
// export default PatientNotificationsSettingsimport { Link } from "react-router";
...
const notifItems = [
  ...
  { key: "appointmentCancellation" as keyof NotificationPreferences, icon: "ti-calendar-x", title: "Appointment Cancellation", desc: "Alert if a appointment is cancel" },
  { key: "labReportReady" as keyof NotificationPreferences, icon: "ti-calendar-time", title: "Lab Report Ready", desc: "Notify when test reports are available" },
...
const PatientNotificationsSettings = () => {
  ...
  const fetchPrefs = async () => {
    try {
      ...
      const res = await fetch(`${BACKEND_URL}/api/patient/notification-preferences`, {
                          ...
                          <div key={item.key}
                            ...
                            <div className="d-flex align-items-center">
                              ...
                              <div>
                                ...
                                <p className="fs-13 mb-0">{item.desc}</p>
                              </div>
                            </div>
                            <div className="d-flex align-items-center gap-4">
