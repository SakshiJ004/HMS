...
exports.updateProfile = async (req, res) => {
    try {
        ...
        const {
            ...
            lastName,
            phone,
            address1,  // ✅ Changed from address.address1
            address2,  // ✅ Changed from address.address2
            country,   // ✅ Changed from address.country
            state,     // ✅ Changed from address.state
            city,      // ✅ Changed from address.city
            pincode,   // ✅ Changed from address.pincode
            profileImage,
        } = req.body;
        ...
        // ✅ Address fields - Initialize if doesn't exist
